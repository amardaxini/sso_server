...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{ ClientApp }
  ...
  #
  config.tenant_names = lambda { ClientApp.pluck  :tenant_name }
...
Rails.application.config.middleware.use 'Apartment::Elevators::Generic', lambda { |request|
  ...
  ClientApp.where(:subdomain=>request.host.split('.').first).first.tenant_name
}
